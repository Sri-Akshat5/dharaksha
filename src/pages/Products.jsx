...
function Products() {
    return (
        <div className="h-screen overflow-y-scroll snap-y snap-mandatory no-scrollbar">
            ...
            {/* Product 1 */}
            <section className="h-screen w-full bg-lime-800/40 py-12 px-4 sm:px-6 flex flex-col justify-center items-center snap-start">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-amber-50 mb-8 sm:mb-12">
                    STATE OF THE ART PACKAGING MATERIAL MADE OUT OF CROP STUBBLE WASTE
                </h2>
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 px-2">
                    ...
                    <div className="flex-1 flex justify-center">
                        <img
                            ...
                            className="w-60 sm:w-80 h-60 sm:h-80 object-cover rounded-xl shadow-lg hover:scale-105 transition-transform duration-500"
                        />
                    </div>
            ...
            <section className="h-screen w-full bg-lime-800/40 py-12 px-4 sm:px-6 flex flex-col justify-center items-center snap-start">
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-8 sm:gap-12 px-2">
